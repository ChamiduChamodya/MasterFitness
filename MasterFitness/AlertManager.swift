...
extension AlertManager {
    ...
    public static func showFetchingWorkoutErrorAlert(on vc : UIViewController, with error : Error){
        self.showBasicalert(on: vc, title: "Unknown Error Fetching Workout", message: nil)
    }
}
